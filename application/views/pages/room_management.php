  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-bed"></i> ROOM MANAGEMENT</li>
      </ol>
    </section>
                            ...
                            <div class="box box-danger">
                              ...
                              <div class="box-body">
                                <table id="tableDetailsTypeRoom" class="table table-bordered table-hover table-condensed">
                                  ...
                                  <tbody>
                                    <!-- <?php
                                    foreach ($Taxget as $key2) {
                                      $nominal = $key2['nominal'];
                                    }
                                     ...
                                     if(! empty($typroom)){
                                      $no = 1;
                                        foreach ($typroom as $key) {
                                          ...
                                          <tr>
                                            <td> <?php echo $no++;?></td>
                                            <td style="text-transform: uppercase;"> <?php echo $key['dsc_tipe'];?> </td>
                                            <!-- <td> Rp. <?php echo number_format($key['price']);?> </td> -->
                                            <td> 
                                              <button type="button" class="btn btn-info btn-sm" title="Edit Type Room" onclick="ubah(<?php echo $id_tipe; ?>)"><i class="fa fa-edit"></i></button> 
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-header" style="background-color: #D33724; color: #FFFFFF;">
                                            ...
                                            <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Master Type Room</h4>
                                          </div>
                                          <!-- body modal -->
...
<!-- 
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <button type="submit" style="margin-right: 15px;" class="btn btn-sm btn-primary" name="submitCompany" title="Update Type Room"><i class="fa fa-refresh"></i> Update</button>
                                          </div>
                                        </div>
                                      </div>
                                  </form>
                                        ...
                                        foreach ($dfasilitasmain as $key) {
                                          ...
                                          <tr>
                                            ...
                                            <td> 
                                             ...
                                             <a href="<?php echo base_url('home/detailfasilitas') ?>/?dsc=<?php echo $dsc_fasilitas ?>&idFasilitas=<?php echo $id_fasilitas; ?>" title="Add Sub Facilities" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                                              <button type="button" class="btn btn-info btn-sm" title="Edit Facilities" onclick="ubahFasilitas(<?php echo $id_fasilitas; ?>)"><i class="fa fa-edit"></i></button> 
                                  ...
                                  <form role="form" action="<?php echo base_url('home/updateFasilitas'); ?>" method="post">
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-header" style="background-color: #D33724; color: #FFFFFF;">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title"><i class="fa fa-edit"></i> Update Facilities</h4>
                                          </div>
                                          <!-- body modal -->
                                          <div class="modal-body">
                                          ...
                                          <div class="modal-footer">
                                            <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Tutup Modal</button> -->
                                            <button type="submit" class="btn btn-sm btn-primary" title="Update Facilities" name="submitCompany"><i class="fa fa-refresh"></i> Update</button>
                                          </div>
                                        </div>
                                      </div>
                                  </form>
                ...
                echo "active";}?>" id="tab_3">
                  <form role="form" action="<?php echo base_url('home/addRoom'); ?>" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <select name="building" class="form-control" required>
                             <?php 
                                foreach ($building as $key) {
                                  echo "<option value='".htmlspecialchars($key['id_building'])."'>";
                                  echo $key['name_building'];
                                  echo "</option>";
                                }
                              ?>
                          </select>
                      ...
                      <div class="form-group col-xs-6">
                        <label for="NoofRoom">Floor</label>
                        <input type="text" name="floor" class="form-control" id="Floor" placeholder="Enter Floor" required>
                      </div>
                      <!-- <div class="form-group col-xs-6 ">
                        <label for="PriceRoom">Price Room</label>
                      ...
                      <div class="form-group col-xs-6">
                        <label for="statusRoom">Status Room</label>
                          <select name="status_room" class="form-control" required>
                             <?php 
                                foreach ($statusRoom as $key) {
                                  echo "<option value='".htmlspecialchars($key['id'])."'>";
                                  echo $key['status'];
                                  echo "</option>";
                                }
                              ?>
                      ...
                      <div class="form-group col-xs-6 ">
                        <label for="maxPerson">Price Room</label>
                        <input type="text" name="price_room" class="form-control" id="priceRoom" placeholder="Enter Price Room" required>
                      </div>
                    <!-- ****************START CHECK BOX NEW**************** -->
                                      ...
                                      $no = 1;
                                        foreach ($room as $key) {
                                          ...
                                          <tr>
                                            ...
                                            <td> <?php echo $key['name_building'];?></td>
                                            ...
                                            <td> 
                                              ...
                                              <button type="button" class="btn btn-success btn-sm" style="width:35px;" title="Add Fasilitas" id="clear" onclick="addSubFasilitasNew(<?php echo $id_room ?>)"><i class="fa fa-plus"></i></button>

                                              <button type="button" class="btn btn-info btn-sm" style="width: 35px;" title="Edit Master Room" onclick="ubahRoom(<?php echo $id_room ?>)"><i class="fa fa-edit"></i></button> 
                                  ...
                                  <form role="form" action="<?php echo base_url('home/'); ?>" method="post">
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-header" style="background-color: #D33724; color: #FFFFFF;">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title"><i class="fa fa-book"></i> View Facilities Room</h4>
                                          </div>
                                          <!-- body modal -->
                                          <div class="modal-body">
                                          ...
                                          <!-- footer modal -->
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-sm btn-danger" title="Close" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                        ...
                        <!-- <form role="form" action="<?php //echo base_url('home/addFasilitasRoom'); ?>" method="post"> -->
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-header" style="background-color: #D33724; color: #FFFFFF;">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title"><i class="fa fa-plus"></i> Add Facilities</h4>
                                          </div>
                                          <!-- body modal -->
                                          <div class="modal-body">
                                  <div class="row">
                               ...
                               <?php
                                ...
                                ?>
                                  ...
                                  <div class="modal-footer">
                                  <button type="submit" class="btn btn-primary btn-sm" title="Submit" onclick="stay()"><i class="fa fa-plus"></i> Submit</button>
                      ...
                      <div id="editModalRoom" class="modal fade " role="dialog">
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header" style="background-color: #D33724; color: #FFFFFF;">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title"><i class="fa fa-edit"></i> Update Master Room</h4>
                            ...
                            <div class="modal-body">
                                <div class="container">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                      <div class="form-group">
                                        <label for="TypeRooms">Building</label>
                                          <select id="buildingRoom" name="building_edit" class="form-control" />
                                            <?php 
                                                foreach ($building as $key) {
                                                  echo "<option value='".htmlspecialchars($key['id_building'])."'>";
                                                  echo $key['name_building'];
                                          ...
                                          <!-- <input type="text" name="building_edit" id="buildingRoom" class="form-control"> -->
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="idFloor" name="floor_edit" />
                                      </div>
                                    </div>
                                      ...
                                      <div class="form-group">
                                        <label for="statusRoom">Status Room</label>
                                          <select id="statusRoom" name="status_room_edit" class="form-control" />
                                            <?php 
                                                foreach ($statusRoom as $key) {
                                                  echo "<option value='".htmlspecialchars($key['id'])."'>";
                                                  echo $key['status'];
                                    ...
                                    <div class="col-sm-5">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="idPriceRoom2" name="price_room_edit" />
                                      </div>
                                    </div>
                                  ...
                                  <div class="modal-footer">
                                  <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Tutup Modal</button>  -->
                                  <button type="submit" class="btn btn-sm btn-primary" name="submitCompany" title="Update Master Room"><i class="fa fa-refresh"></i> Update</button>
                                </form>
                                </div>
                              </div>
